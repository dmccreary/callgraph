...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:dotml="http://www.martin-loetzsch.de/DOTML" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <!-- 
File dotml2dot.xsl 
...
-->
    ...
    <xsl:template match="dotml:graph">
        <dummy>digraph g {compound="true";<xsl:call-template name="copy-attributes">
